...
def encode(filepath):
    ...
    if video_codec[0] == 'hevc':
        ...
        video_opts = '-c:v libx265 -preset veryfast -rc vbr -cq 25 -qmin 25 -qmax 25 -b:v 0 -profile:v main10 -pix_fmt p010le -rc-lookahead 40 -no-scenecut 1 -init_qpP 23 -init_qpB 25 -init_qpI 21 -weighted_pred 1 -map 0:v -map_chapters 0 -c:s copy -map 0:s? -c:t copy -map 0:t?'
